...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_ACIDBLOOD" = TRAIT_ACIDBLOOD, //IRIS ADDITION
		...
		// OCULIS EDIT ADDITION START - TRAIT_ARACHNID_WEB_SURFER - Adds the web surfer trait
		"TRAIT_ARACHNID_WEB_SURFER" = TRAIT_ARACHNID_WEB_SURFER,
		...
		"TRAIT_MEDIUM_NIGHT_VISION" = TRAIT_MEDIUM_NIGHT_VISION, //IRIS ADDITION
	...
	/obj/item/toy/plush/nova = list(
		...
		"TRAIT_HOLOSYNTH" = TRAIT_HOLOSYNTH,
	...
	/obj/item/toy/plush/iris = list(
		"TRAIT_CAFFEINE_DEPENDENCE" = TRAIT_CAFFEINE_DEPENDENCE, //Ports https://github.com/Monkestation/Monkestation2.0/pull/5623
		"TRAIT_HANDEDNESS" = TRAIT_HANDEDNESS,
		"TRAIT_HANDEDNESS_LEFT" = TRAIT_HANDEDNESS_LEFT,
		"TRAIT_BELT_SATCHEL" = TRAIT_BELT_SATCHEL,
		"TRAIT_PARANOIA" = TRAIT_PARANOIA, //EXTRA-SENSORY PARANOIA QUIRK AS PART OF https://github.com/Monkestation/Monkestation2.0/pull/313
		"TRAIT_SALT_VULNERABILITY" = TRAIT_SALT_VULNERABILITY,
		"TRAIT_STOWAWAY" = TRAIT_STOWAWAY,
		"TRAIT_SOMATIC_VOLATILITY" = TRAIT_SOMATIC_VOLATILITY,
		...
		"COLORBLINDNESS_PROTANOPIA" = COLORBLINDNESS_PROTANOPIA,
		"COLORBLINDNESS_DEUTERANOPIA" = COLORBLINDNESS_DEUTERANOPIA,
		"COLORBLINDNESS_TRITANOPIA" = COLORBLINDNESS_TRITANOPIA,
		"TRAIT_TABLE_EATING_ENJOYER" = TRAIT_TABLE_EATING_ENJOYER,
		"TRAIT_UNDERSIZED" = TRAIT_UNDERSIZED,
		"FARSIGHT_TRAIT" = FARSIGHT_TRAIT,
